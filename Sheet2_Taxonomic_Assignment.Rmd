...
```{r, include = FALSE} 
#seqtab <- readRDS("objects/Sheet1/seqtab.rds") ### En el Sheet1 ya los habiamos cargado, nos saltamos este paso
...
alignment <- readRDS("/home/analisis16/objects/Sheet2/alignment.rds")

#phangAlign <- phyDat(as(alignment, "matrix"), type="DNA")
phangAlign<- readRDS("/home/analisis16/objects/Sheet2/alignment.rds")

#dm <- dist.ml(phangAlign)
#treeNJ <- NJ(dm)
treeNJ <- readRDS("/home/analisis16/objects/Sheet2/treeNJ.rds")

#fit <- pml(treeNJ, data=phangAlign)
fit<- readRDS("/home/analisis16/objects/Sheet2/fit.rds")

#fitGTR <- update(fit, k=4, inv=0.2)
#fitGTR <- optim.pml(fitGTR, model="GTR", optInv=TRUE, optGamma=TRUE,
                    #rearrangement = "stochastic", control = pml.control(trace = 0))
fitGTR<- readRDS("/home/analisis16/objects/Sheet2/fitGTR.rds")
```
### en este punto correr abajo en la consola: options(Biostrings.coloring=TRUE)
### Luego correr: alignment - aparecerá el gráfico
